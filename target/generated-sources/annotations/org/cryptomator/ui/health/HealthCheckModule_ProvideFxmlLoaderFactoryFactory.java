...
public final class HealthCheckModule_ProvideFxmlLoaderFactoryFactory
  ...
  public HealthCheckModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static HealthCheckModule_ProvideFxmlLoaderFactoryFactory create(
      Provider<Map<Class<? extends FxController>, Provider<FxController>>> factoriesProvider,
      Provider<DefaultSceneFactory> sceneFactoryProvider,
      Provider<ResourceBundle> resourceBundleProvider) {
    return new HealthCheckModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static FxmlLoaderFactory provideFxmlLoaderFactory(
    ...
    return Preconditions.checkNotNullFromProvides(
        HealthCheckModule.provideFxmlLoaderFactory(factories, sceneFactory, resourceBundle));
  }
}
