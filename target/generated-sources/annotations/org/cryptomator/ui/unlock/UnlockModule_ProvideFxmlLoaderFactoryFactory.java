...
public final class UnlockModule_ProvideFxmlLoaderFactoryFactory
  ...
  public UnlockModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static UnlockModule_ProvideFxmlLoaderFactoryFactory create(
      Provider<Map<Class<? extends FxController>, Provider<FxController>>> factoriesProvider,
      Provider<DefaultSceneFactory> sceneFactoryProvider,
      Provider<ResourceBundle> resourceBundleProvider) {
    return new UnlockModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static FxmlLoaderFactory provideFxmlLoaderFactory(
    ...
    return Preconditions.checkNotNullFromProvides(
        UnlockModule.provideFxmlLoaderFactory(factories, sceneFactory, resourceBundle));
  }
}
