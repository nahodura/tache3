...
public final class MigrationModule_ProvideStageFactory implements Factory<Stage> {
  ...
  public MigrationModule_ProvideStageFactory(
  ...
  public static MigrationModule_ProvideStageFactory create(
      Provider<StageFactory> factoryProvider,
      Provider<Stage> ownerProvider,
      Provider<ResourceBundle> resourceBundleProvider) {
    return new MigrationModule_ProvideStageFactory(
  ...
  public static Stage provideStage(
    ...
    return Preconditions.checkNotNullFromProvides(
        MigrationModule.provideStage(factory, owner, resourceBundle));
  }
}
