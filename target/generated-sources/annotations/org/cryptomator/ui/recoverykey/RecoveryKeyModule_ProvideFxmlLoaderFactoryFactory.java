...
public final class RecoveryKeyModule_ProvideFxmlLoaderFactoryFactory
  ...
  public RecoveryKeyModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static RecoveryKeyModule_ProvideFxmlLoaderFactoryFactory create(
      Provider<Map<Class<? extends FxController>, Provider<FxController>>> factoriesProvider,
      Provider<DefaultSceneFactory> sceneFactoryProvider,
      Provider<ResourceBundle> resourceBundleProvider) {
    return new RecoveryKeyModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static FxmlLoaderFactory provideFxmlLoaderFactory(
    ...
    return Preconditions.checkNotNullFromProvides(
        RecoveryKeyModule.provideFxmlLoaderFactory(factories, sceneFactory, resourceBundle));
  }
}
