...
public final class ChangePasswordModule_ProvideNewPasswordControllerFactory
    implements Factory<FxController> {
  private final Provider<ResourceBundle> resourceBundleProvider;

  private final Provider<PasswordStrengthUtil> strengthRaterProvider;

  public ChangePasswordModule_ProvideNewPasswordControllerFactory(
  ...
  public static ChangePasswordModule_ProvideNewPasswordControllerFactory create(
      Provider<ResourceBundle> resourceBundleProvider,
      Provider<PasswordStrengthUtil> strengthRaterProvider) {
    return new ChangePasswordModule_ProvideNewPasswordControllerFactory(
  ...
  public static FxController provideNewPasswordController(
    ...
    return Preconditions.checkNotNullFromProvides(
        ChangePasswordModule.provideNewPasswordController(resourceBundle, strengthRater));
  }
}
