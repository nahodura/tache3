...
public final class QuitModule_ProvideFxmlLoaderFactoryFactory
  ...
  public QuitModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static QuitModule_ProvideFxmlLoaderFactoryFactory create(
      Provider<Map<Class<? extends FxController>, Provider<FxController>>> factoriesProvider,
      Provider<DefaultSceneFactory> sceneFactoryProvider,
      Provider<ResourceBundle> resourceBundleProvider) {
    return new QuitModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static FxmlLoaderFactory provideFxmlLoaderFactory(
    ...
    return Preconditions.checkNotNullFromProvides(
        QuitModule.provideFxmlLoaderFactory(factories, sceneFactory, resourceBundle));
  }
}
