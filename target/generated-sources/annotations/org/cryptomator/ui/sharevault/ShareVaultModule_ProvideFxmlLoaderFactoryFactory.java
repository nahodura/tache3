...
public final class ShareVaultModule_ProvideFxmlLoaderFactoryFactory
  ...
  public ShareVaultModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static ShareVaultModule_ProvideFxmlLoaderFactoryFactory create(
      Provider<Map<Class<? extends FxController>, Provider<FxController>>> factoriesProvider,
      Provider<DefaultSceneFactory> sceneFactoryProvider,
      Provider<ResourceBundle> resourceBundleProvider) {
    return new ShareVaultModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static FxmlLoaderFactory provideFxmlLoaderFactory(
    ...
    return Preconditions.checkNotNullFromProvides(
        ShareVaultModule.provideFxmlLoaderFactory(factories, sceneFactory, resourceBundle));
  }
}
