...
public final class AddVaultModule_ProvideFxmlLoaderFactoryFactory
  ...
  public AddVaultModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static AddVaultModule_ProvideFxmlLoaderFactoryFactory create(
      Provider<Map<Class<? extends FxController>, Provider<FxController>>> factoriesProvider,
      Provider<DefaultSceneFactory> sceneFactoryProvider,
      Provider<ResourceBundle> resourceBundleProvider) {
    return new AddVaultModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static FxmlLoaderFactory provideFxmlLoaderFactory(
    ...
    return Preconditions.checkNotNullFromProvides(
        AddVaultModule.provideFxmlLoaderFactory(factories, sceneFactory, resourceBundle));
  }
}
