...
public final class DokanySupportEndModule_ProvideFxmlLoaderFactoryFactory
  ...
  public DokanySupportEndModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static DokanySupportEndModule_ProvideFxmlLoaderFactoryFactory create(
      Provider<Map<Class<? extends FxController>, Provider<FxController>>> factoriesProvider,
      Provider<DefaultSceneFactory> sceneFactoryProvider,
      Provider<ResourceBundle> resourceBundleProvider) {
    return new DokanySupportEndModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static FxmlLoaderFactory provideFxmlLoaderFactory(
    ...
    return Preconditions.checkNotNullFromProvides(
        DokanySupportEndModule.provideFxmlLoaderFactory(factories, sceneFactory, resourceBundle));
  }
}
