...
public final class VaultStatisticsModule_ProvideFxmlLoaderFactoryFactory
  ...
  public VaultStatisticsModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static VaultStatisticsModule_ProvideFxmlLoaderFactoryFactory create(
      Provider<Map<Class<? extends FxController>, Provider<FxController>>> factoriesProvider,
      Provider<DefaultSceneFactory> sceneFactoryProvider,
      Provider<ResourceBundle> resourceBundleProvider) {
    return new VaultStatisticsModule_ProvideFxmlLoaderFactoryFactory(
  ...
  public static FxmlLoaderFactory provideFxmlLoaderFactory(
    ...
    return Preconditions.checkNotNullFromProvides(
        VaultStatisticsModule.provideFxmlLoaderFactory(factories, sceneFactory, resourceBundle));
  }
}
